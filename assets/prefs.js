...
pref("app.update.url", "https://jurism.xyz/jurism/update.php/%VERSION%/%BUILD_ID%/%BUILD_TARGET%/%LOCALE%/%CHANNEL%/%OS_VERSION%/update.xml");
...
pref("app.update.url.details", "https://juris-m.github.io");
